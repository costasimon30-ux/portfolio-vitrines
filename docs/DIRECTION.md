...
**Passe photographique implémentée ; revue UI/UX effectuée avec avis favorable ; rendu esthétique validé par Simon le 7 septembre 2026. Le renommage du lien de crédits est décidé, à implémenter par Claude. La réserve de droits tiers concernant P06 reste ouverte et distincte de l'accord artistique.**
...
2. **Libellé du lien de crédits — décidé, à implémenter.** Simon délègue ce choix au Chef de projet. Libellé retenu : « Crédits et licences photographiques », plus compréhensible pour le visiteur que le chemin technique `assets/photos/NOTICE.md`. Claude est autorisé à remplacer uniquement le texte de ce lien dans les quatre pieds de page, sans modifier sa destination, les autres crédits, la notice, les médias ou la mise en page. Vérification proportionnée : présence du nouveau libellé sur les quatre pages, destination conservée et absence de débordement à 320 px. Pas de nouvelle revue générale requise pour cette seule retouche. L'implémentation reste à confirmer par le commit de Claude.
...
Le dernier accord de Simon ne comporte aucun arbitrage sur P06 ; la délégation concernant les crédits ne s'étend pas aux droits photographiques, au retrait/remplacement d'un média ni à sa diffusion.
